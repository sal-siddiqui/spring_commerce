...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initData() {
        ...
        final Category category_2 =
                new Category(null, "Clothing", new ArrayList<>());
        final Category category_3 =
                new Category(null, "Books", new ArrayList<>());
        this.categoryRepository
                .saveAll(List.of(category_1, category_2, category_3));
        // Products
        final Product product_1 = new Product(null, "Galaxy Z Flip",
                "Foldable smartphone with AMOLED display", 50, 999.99, 10.0,
                null, "default.jpg", category_1, user_1, new ArrayList<>());
        ...
        final Product product_2 =
                new Product(null, "Noise Cancelling Headphones",
                        ...
                        120, 199.49, 10.0, null, "default.jpg", category_1,
                        user_2, new ArrayList<>());
        ...
        final Product product_4 = new Product(null, "Graphic Hoodie",
                "Unisex cotton hoodie with graphic print", 100, 45.0, 50.0,
                null, "default.jpg", category_2, user_1, new ArrayList<>());
        ...
        final Product product_7 = new Product(null, "The Art of War",
                "Ancient Chinese military treatise by Sun Tzu", 200, 12.99,
                10.0, null, "default.jpg", category_3, user_1,
                new ArrayList<>());
        ...
        final Product product_8 = new Product(null, "Atomic Habits",
                "A guide to building good habits by James Clear", 80, 55.0,
                12.0, null, "default.jpg", category_3, user_2,
                new ArrayList<>());
        ...
        this.productRepository
                .saveAll(List.of(product_1, product_2, product_3, product_4,
